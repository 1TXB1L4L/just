...
--
-- Servidor: localhost
-- Tiempo de generación: 15-07-2023 a las 21:12:08
...
--
-- Estructura de tabla para la tabla `aibot`
--
...
(1, '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', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `chatbot_templet`
--
...
--
-- Volcado de datos para la tabla `chatbot_templet`
--
...
(27, 11, 'Asistente Real State', 'Soy un experto en bienes raices y estoy aqui para ayudarle a los clientes con sus dudas y peticiones , solo hablare de propiedades que esten anunciadas en https://businessbrokers.com y me limitare a dar consejo para que busquen y encuentre la propiedad que mas les guste dentro de esta pagina.', '2023-07-12 06:42:46');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `embed_chatbot`
--
...
--
-- Volcado de datos para la tabla `embed_chatbot`
--
...
(3, 'RqM3YMDJxciuPr22JIww3Ve4blftQ3Xc', 1, 'soy un experto en bienes raices', 'nostra', 'sNjumiJ2nkjAhnVoLy', '2023-07-12 03:45:01'),
(4, 'RqM3YMDJxciuPr22JIww3Ve4blftQ3Xc', 1, 'Soy un experto en bienes raices y estoy aqui para ayudarle a los clientes con sus dudas y peticiones , solo hablare de propiedades que esten anunciadas en https://businessbrokers.com y me limitare a dar consejo para que busquen y encuentre la propiedad que mas les guste dentro de esta pagina.', 'Asistente en Bienes Raices', 'QXdN4qkyY7aGK613kB', '2023-07-12 06:48:07');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `embed_chats`
--
...
--
-- Volcado de datos para la tabla `embed_chats`
--
...
(33, 'RqM3YMDJxciuPr22JIww3Ve4blftQ3Xc', 'admin@admin.com', '88888888', 'juan mendez fonseca', 'sNjumiJ2nkjAhnVoLy', NULL, '2023-07-12 03:48:53');
...
--
-- Estructura de tabla para la tabla `generated_images`
--
...
--
-- Volcado de datos para la tabla `generated_images`
--
...
(13, 'RqM3YMDJxciuPr22JIww3Ve4blftQ3Xc', 'https://oaidalleapiprodscus.blob.core.windows.net/private/org-u9VPO4xc7vs9OdpIbJ0KtkdR/user-4bsJZCBQgvZnBvC5dOpPnEiQ/img-SjUAWT05un08juxhU6QLkuLo.png?st=2023-07-13T16%3A54%3A40Z&se=2023-07-13T18%3A54%3A40Z&sp=r&sv=2021-08-06&sr=b&rscd=inline&rsct=image/png&skoid=6aaadede-4fb3-4698-a8f6-684d7786b067&sktid=a48cca56-e6da-484e-a814-9c849652bcb3&skt=2023-07-12T20%3A27%3A07Z&ske=2023-07-13T20%3A27%3A07Z&sks=b&skv=2021-08-06&sig=JdK6GHEw5iWLcbPYdBH%2B0BiXva4ZPiLXO0Eh8omNZKs%3D', '1689270880372_28171.png', '1024x1024', 'crear afiche con texto diciendo gratis', '2023-07-13 17:54:42');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `generated_wp`
--
...
--
-- Volcado de datos para la tabla `generated_wp`
--
...
--
-- Estructura de tabla para la tabla `ping`
--
...
--
-- Volcado de datos para la tabla `ping`
--
...
(6, 'RqM3YMDJxciuPr22JIww3Ve4blftQ3Xc', 'lol', NULL, '2023-07-12 03:49:54');
...
(17, 'BussinesBrokers', 99999999, 99999999, 1, 99999997, '1024x1024', 1, 1, 1, 1, 99999999, 1, 0, 1, 1, 99999999, '99999999', '2023-07-12 06:47:50');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `stt`
--
...
--
-- Volcado de datos para la tabla `stt`
--
...
--
-- Estructura de tabla para la tabla `templet_category`
--
...
--
-- Volcado de datos para la tabla `templet_category`
--
...
(10, 'Whatsapp', '2023-07-12 03:31:42'),
(11, 'Real State', '2023-07-12 06:39:18');
...
--
-- Estructura de tabla para la tabla `tts`
--
...
--
-- Indices de la tabla `chatbot_templet`
--
ALTER TABLE `chatbot_templet`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `embed_chatbot`
--
ALTER TABLE `embed_chatbot`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `embed_chats`
--
...
--
-- Indices de la tabla `generated_images`
--
ALTER TABLE `generated_images`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `generated_wp`
--
...
--
-- Indices de la tabla `stt`
--
ALTER TABLE `stt`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `templet_category`
--
...
--
-- AUTO_INCREMENT de la tabla `aibot`
--
ALTER TABLE `aibot`
...
--
-- AUTO_INCREMENT de la tabla `chatbot_templet`
--
ALTER TABLE `chatbot_templet`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `embed_chatbot`
--
ALTER TABLE `embed_chatbot`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `embed_chats`
--
ALTER TABLE `embed_chats`
...
--
-- AUTO_INCREMENT de la tabla `generated_images`
--
ALTER TABLE `generated_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `generated_wp`
--
ALTER TABLE `generated_wp`
...
--
-- AUTO_INCREMENT de la tabla `ping`
--
ALTER TABLE `ping`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT de la tabla `stt`
--
ALTER TABLE `stt`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `templet_category`
--
ALTER TABLE `templet_category`
...
--
-- AUTO_INCREMENT de la tabla `tts`
--
ALTER TABLE `tts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
